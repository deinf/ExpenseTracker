...
class MyChartView extends StatefulWidget {
  const MyChartView({super.key});

  @override
  State<MyChartView> createState() => _MyChartViewState();
}

class _MyChartViewState extends State<MyChartView> {
  @override
  ...
  List<BarChartGroupData> showBarGroups() => List.generate(
        8,
        (index) {
          switch (index) {
            case 0:
